...
const FeaturedDestinations = () => {
  ...
  if (loading) {
    return (
      <section className="py-20 bg-background-white text-center no-select">
  ...
  return (
    <section className="py-20 bg-background-white">
      <div className="max-w-7xl mx-auto px-4 no-select">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          {descripcion && (
            <p className="text-lg text-light no-select">{descripcion}</p>
          )}
        </div>
